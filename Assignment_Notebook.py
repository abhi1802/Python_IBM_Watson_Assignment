...
x = pd.DataFrame(d2, columns = ['date']) # Create your dataframe with column date
x.head()
...
gdp_change = pd.DataFrame(d1, columns = ['change-current']) # Create your dataframe with column change-current
gdp_change.head()
...
unemployment = pd.DataFrame(d2, columns = ['unemployment'])# Create your dataframe with column unemployment
unemployment.head()
...
title = "Unemployment Statistics according to GDP" # Give your dashboard a string title
